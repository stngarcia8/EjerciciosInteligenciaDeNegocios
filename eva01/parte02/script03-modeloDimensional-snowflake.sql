...
CREATE TABLE dbo.sdim_estadocivil
(
...
(
    ...
    REFERENCES dbo.sdim_estadocivil ( id_estadocivil),
    CONSTRAINT paciente_sexo_fk FOREIGN KEY ( id_sexo )
    REFERENCES dbo.sdim_sexo ( id_sexo )
);
GO
...
(
    ...
    REFERENCES dbo.sdim_titulo ( id_titulo )
);
GO


CREATE TABLE dbo.sdim_medicamento
(
...
CREATE TABLE dbo.sdim_receta_ATENCION
(
    ...
    REFERENCES dbo.sdim_medicamento ( id_medicamento )
);
GO
